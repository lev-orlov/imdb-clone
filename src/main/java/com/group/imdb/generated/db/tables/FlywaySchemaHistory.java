...
import com.group.imdb.generated.db.tables.records.FlywaySchemaHistoryRecord;
import org.jooq.*;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
    ...
    private static final long serialVersionUID = -2045314024;
     ...
     */
    public final TableField<FlywaySchemaHistoryRecord, Timestamp> INSTALLED_ON = createField("installed_on", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("now()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
